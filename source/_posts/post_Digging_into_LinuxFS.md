...
{% image fancybox image2.png http://res.cloudinary.com/gotocco/image/upload/c_scale,w_509/v1531260498/Screen_Shot_2018-07-10_at_23.07.38_hknfbe.png "picture.2 Classical Storage stack architecture Filesystem - Volume Manager" %}
...
{% image fancybox  image3.png http://res.cloudinary.com/gotocco/image/upload/c_scale,w_509/v1531260498/Screen_Shot_2018-07-10_at_23.07.38_hknfbe.png "picture.3 Storage stack marked on Linux Kernel Map" %}
...
So as we can see we were able to save 10 times of our storage medium! It looks incredible but in reality, we used the trick by storing de facto same content copied many times. In reality, the ratio will depend on the files that you store.
